...
<div id="page" class="site">
	...
	<header id="header-melissa" class="site-header fixed-top">
...
<!-- 
				...
				<div class="collapse navbar-collapse" id="navbar-content">
					<?php
					wp_nav_menu( array(
						'theme_location' => 'left-main-menu', // Defined when registering the menu
				...
				<a class="navbar-brand" href="<?php echo esc_url( home_url( '/' ) ); ?>">
					<img class="logo img-fluid mx-auto" src="<?php the_field('site_logo', 'option') ?>">
				</a>
				...
				<div class="collapse navbar-collapse" id="navbar-content">
					<?php
					wp_nav_menu( array(
						'theme_location' => 'right-main-menu', // Defined when registering the menu
